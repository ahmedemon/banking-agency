...
<div class="content-w">
    <div class="content-i">
        <div class="content-box">
            <div class="row">
                <div class="col-sm-12">
                    <h6 class="element-header text-center">Member Search for Common collections</h6>
                    <div class="element-box">
                        <form method="POST" action="{{ route('credits.common.search') }}" accept-charset="UTF-8" class="form-inline justify-content-center"> @csrf
