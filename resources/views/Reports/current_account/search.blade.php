...
<div class="content-w">
    <div class="content-i">
        <div class="content-box">
            <div class="row">
                <div class="col-sm-12">
                    <h6 class="element-header text-center">Report Search For Current Account</h6>
                    <div class="element-box">
                        <form method="POST" action="{{ route('report.caccount.search.post') }}" accept-charset="UTF-8" class="form-inline justify-content-center">
                            @csrf
